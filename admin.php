...
<?php include("top_nav.php"); ?>
    ...
    <div class="container" style="margin-top:70px;">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header text-light"><i class='fa fa-user-md'></i> Admin Login
			...
			<div class="row">
				...
				if(isset($_POST["submit"]))
					{
						$sql= "SELECT * from  nss_log where user_id LIKE{'$user'} and user_pwd LIKE{'pass'}
						$result=$con->query($sql);
                        if($result->num_rows>0)
						if($row['nss_type']=='admin')
						...
						if($row['nss_type']=='volunteer')

						{
							 $_SESSION['usertype'] ='volunteer';
							 $_SESSION['username']='volunteer';

							
							header("location:vol_inbox.php");
						}
